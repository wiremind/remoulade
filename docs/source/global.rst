...
.. |RateLimitBackend| replace:: :class:`RateLimitBackend<remoulade.rate_limits.RateLimitBackend>`
.. |RateLimitEnqueue| replace:: :class:`RateLimitEnqueue<remoulade.rate_limits.RateLimitEnqueue>`
.. |RateLimitProcess| replace:: :class:`RateLimitProcess<remoulade.rate_limits.RateLimitProcess>`
...
.. |ConcurrencyLimitExceeded| replace:: :class:`ConcurrencyLimitExceeded<remoulade.concurrent.ConcurrencyLimitExceeded>`
.. |Concurrent| replace:: :class:`Concurrent<remoulade.concurrent.Concurrent>`
.. |ConcurrencyBackend| replace:: :class:`ConcurrencyBackend<remoulade.concurrent.ConcurrencyBackend>`
