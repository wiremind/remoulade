...
latex_documents = [
    (master_doc, "remoulade.tex", "remoulade Documentation", "Bogdan Popa", "manual"),
]
...
man_pages = [(master_doc, "remoulade", "remoulade Documentation", [author], 1)]
